...
public class UserDetailsFactory {
	...
	public static List<UserDetailsProjection> createCustomClientUser(String username) {
		...
		list.add(new UserDetailsImpl(username, "$2a$10$BfQ6lnNL22CPk91XstWDbOQ0ETzdXV43X4ep5rKI9AM0NWMa90BT2", 2L, "ROLE_USER"));
		return list;
	}
	...
	public static List<UserDetailsProjection> createCustomAdminUser(String username) {
		...
		List<UserDetailsProjection> list = new ArrayList<>();
		list.add(new UserDetailsImpl(username, "$2a$10$BfQ6lnNL22CPk91XstWDbOQ0ETzdXV43X4ep5rKI9AM0NWMa90BT2", 1L, "ROLE_ADMIN"));
		return list;
	}
